...
//
//    distortion.at<float>(0, 0) = 0.049151;
//    distortion.at<float>(1, 0) = -0.24035;
//    distortion.at<float>(2, 0) = -0.001841;
//    distortion.at<float>(3, 0) = -0.000271;
//    distortion.at<float>(4, 0) = 0.19756;

    /**distortion.at<float>(0, 0) = 0.0493f;
    distortion.at<float>(1, 0) = -0.1878f;
    distortion.at<float>(2, 0) = -0.003149f;
    distortion.at<float>(3, 0) = -0.00053f;
    distortion.at<float>(4, 0) = 0.1215f; **/
...
float MarkerDetector::detect(const cv::Mat &input,float markerSizeMeters, vector<cv::Point2f> &points2d, vector<cv::Point3f> &points3d) throw ( cv::Exception )
{
